  ...
  return (
    <>
      <SEO 
        ...
        description="Accelerate your impact with AI and machine learning. Expert strategic technology advisory services including ML capability acceleration, AI-driven innovation sprints, and digital transformation audits."
        keywords="AI consulting, machine learning services, digital transformation, strategic technology advisory, ML capability accelerator, AI innovation sprint"
        url="/services"
      />
      <section className="bg-background py-16 min-h-[70vh]">
        <div className="container mx-auto max-w-5xl px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {/* Service 1 */}
            <div className="rounded-3xl p-8 xl:p-10 ring-1 ring-border bg-card flex flex-col">
              <h3 className="text-lg font-semibold leading-8 text-foreground mb-2">ML Capability Accelerator</h3>
              ...
              <div className="mt-6 flex items-baseline gap-x-2">
                <span className="text-3xl font-bold tracking-tight text-foreground">$100k-$200k</span>
                <span className="text-sm font-semibold leading-6 text-muted-foreground">8-16 Weeks</span>
              </div>
